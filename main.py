...
class TicketTypeSelect(discord.ui.View):
    ...
    @discord.ui.select(
        ...
        max_values=1,
        options=[
            discord.SelectOption(label="Support", description="General support", emoji="ðŸ› ï¸"),
            discord.SelectOption(label="Report", description="Report a user or issue", emoji="ðŸš¨"),
            discord.SelectOption(label="Appeal", description="Appeal a decision", emoji="âš–ï¸"),
        ],
    ...
    async def select_ticket_type(self, interaction: discord.Interaction, select: discord.ui.Select):
        ...
        embed = discord.Embed(
            title=f"ðŸŽŸï¸ {ticket_type} Ticket #{ticket_number}",
...
class TicketControlView(discord.ui.View):
    ...
    @discord.ui.button(label="ðŸŸ¢ Claim Ticket", style=discord.ButtonStyle.primary)
    async def claim_ticket(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        async for msg in interaction.channel.history(limit=10):
            if msg.embeds:
                ...
                embed.description += f"\n\nðŸŸ¢ **Claimed by:** {interaction.user.mention}"
